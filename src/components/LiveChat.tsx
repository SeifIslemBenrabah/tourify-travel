    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3 pointer-events-none">
      <div className="pointer-events-auto flex flex-col md:flex-row gap-3">
        <a
          ...
          className="w-14 h-14 rounded-full bg-green-500 hover:bg-green-600 text-primary flex items-center justify-center shadow-xl transition-all duration-300 hover:scale-105"
